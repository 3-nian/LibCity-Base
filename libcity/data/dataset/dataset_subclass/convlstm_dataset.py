import os
import numpy as np
from libcity.data.dataset import TrafficStateCPTODDataset, TrafficStateGridOdDataset
from libcity.utils.dataset import timestamp2array, timestamp2vec_origin


class CONVLSTMDataset(TrafficStateGridOdDataset, TrafficStateCPTODDataset):
    """
